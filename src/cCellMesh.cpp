...
cCellMesh::cCellMesh(std::string file_name, cPetscSolver *s){
...
void cCellMesh::print_info(){
	if(solver->mpi_rank == 0){
		std::cout << "<MESH> MPI_rank:0 nodes_count: " << nodes_count << std::endl;
		std::cout << "<MESH> MPI_rank:0 total_elements_count: " << total_elements_count << std::endl;
		std::cout << "<MESH> MPI_rank:0 surface_elements_count: " << surface_elements_count << std::endl;
		std::cout << "<MESH> MPI_rank:0 volume_elements_count: " << volume_elements_count << std::endl;
	}
	solver->sync_flush();
}
